...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static final String URL_SAVE_NAME = "http://abedkiloo.com/saveName.php";
    ...
    //List to store all the namesnet
    ...
    public static final String DATA_SAVED_BROADCAST = "dev-abed-saved";
